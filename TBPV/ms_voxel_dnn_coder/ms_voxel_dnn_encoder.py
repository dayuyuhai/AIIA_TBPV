...
# python3 -m  ms_voxel_dnn_coder.ms_voxel_dnn_encoder -level 10 -depth 3 -ply ./datasets_bp/MPEG/10bitdepth/train/longdress_vox10_1052.ply -output Output/ -signaling msvxdnn -model Model/MSVoxelCNN/ -model8 ./Model/voxelDNNBL8_tf0/
# python3 -m  ms_voxel_dnn_coder.ms_voxel_dnn_encoder -level 10 -depth 3 -ply ./datasets_bp/Microsoft/10bitdepth/train/frame0004.ply -output Output/ -signaling msvxdnn -model Model/MSVoxelCNN/ -model8 ./Model/voxelDNNBL8_tf0/
